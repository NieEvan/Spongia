      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {recentSkills.map(skill => {
          ...
          return (
            <div
              key={skill.name}
              className="bg-slate-50 border border-slate-100 p-3.5 sm:p-4 rounded-[1.25rem] flex items-center gap-3 min-w-0 transition-all hover:bg-slate-100/80 hover:border-slate-200"
            >
              <div
