    ...
    return (
        <div className="min-h-screen flex flex-col bg-background font-sans selection:bg-brand-blue/20">
            ...
            <section className="relative min-h-[85vh] flex items-center pt-20 pb-20 px-6 overflow-hidden">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center relative z-10 h-full">
                    {/* Left Column: Text Content */}
                    <motion.div
                        initial={{ opacity: 0, x: -20 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.6 }}
                        className="text-left flex flex-col justify-center h-full py-10"
                    >
                        <div className="mb-6">
                            <span className="text-[#75757A] font-medium text-sm tracking-wide">Complete preparation</span>
                        </div>

                        <h1 className="text-6xl md:text-7xl lg:text-[5.5rem] font-medium tracking-tight text-[#1D1D1F] leading-[1.05] mb-12">
                            Master the <br />
                            Digital SAT.
                        </h1>

                        <div className="flex flex-col sm:flex-row gap-4 mb-20 md:mb-32 relative z-20">
                            <Link to="/auth">
                                <Button size="lg" className="h-14 px-10 text-base font-normal rounded-full bg-black text-white hover:bg-black/90 transition-all shadow-none">
                                    Try for free
                                    <ArrowRight className="ml-2 w-4 h-4" />
                                </Button>
                            </Link>
                            <Link to="/pricing">
                                <Button variant="outline" size="lg" className="h-14 px-10 text-base font-normal rounded-full border border-[#E5E5EA] bg-transparent hover:bg-slate-50 text-[#1D1D1F] transition-all shadow-none">
                                    View Pricing
                                </Button>
                            </Link>
                        </div>

                        <div className="flex flex-col md:flex-row gap-6 lg:gap-12 w-full mt-auto relative z-20">
                            <div className="flex items-start gap-2 shrink-0 md:w-36">
                                <span className="text-lg font-light leading-none mt-0.5">+</span>
                                <div className="text-sm font-medium text-[#1D1D1F] leading-snug">
                                    One Platform<br />
                                    For All Skills
                                </div>
                            </div>
                            <p className="text-sm text-[#75757A] flex-1 leading-relaxed max-w-sm">
                                Practice 1000+ original questions generated by our state-of-the-art AI models, available in one intuitive interface. No more switching between dozens of platforms.
                            </p>
                        </div>
                    </motion.div>
